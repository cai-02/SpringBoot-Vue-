...
public interface ArticleDao {
    ...
    public List<Article> getAllArticleByAuthorCate(@Param("author") String author, @Param("categoryId") int categoryId, @Param("title") String title, @Param("pageStart") int pageStart, @Param("pageSize") int pageSize);
    //查询最近更改的五篇笔记
    public List<Article> getArticleByTime(@Param("author") String author);
    //笔记总数
    public int getArticleCounts(@Param("author") String author);
    public int getArticleCountsByCate(@Param("author") String author, @Param("categoryId") int categoryId);
